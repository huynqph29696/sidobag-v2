...
<div class="container">
    ...
    <div class="row">
        <button type="button" class="btn btn-outline-secondary mt-5 rounded-pill" data-bs-toggle="modal"
            ...
            <i class="bi bi-plus-square-fill"></i> <span>THÊM DANH MỤC</span>
        </button>
                ...
                <tr id="record_${sp.id}">
                    ...
                    <td>
                        ...
                        <ul class="dropdown-menu">
                            <li>
                            <li>
                                <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#modalUpdateDanhMuc${sp.id}"><i class="bi bi-pencil"></i> Sửa
                                </button>
                            </li>

                            </li>
                            <a class="dropdown-item delete-color" href="#" onclick="xoaDanhMuc(${sp.id})"><i class="bi bi-trash3"></i> Xóa</a>
                            <li>
                        ...
                        <div class="modal fade" id="modalUpdateDanhMuc${sp.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="mb-3 row">
                                                <label for="maUpdate${sp.id}" class="col-sm-3 col-form-label">Mã Danh Mục <span>*</span></label>
                                                <div class="col-sm-9">
                                                    <input value="${sp.maDanhMuc}" name="maDanhMuc" id="maUpdate${sp.id}" class="form-control" readonly
                                                    >
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                <label for="tenUpdate${sp.id}" class="col-sm-3 col-form-label">Tên Danh Mục <span>*</span></label>
                                                <div class="col-sm-9">
                                                    <input value="${sp.tenDanhMuc}" name="tenDanhMuc" id="tenUpdate${sp.id}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <button type="submit" id="uploadButton" class="btn btn-primary" onclick="updateDanhMuc(${sp.id})">Lưu</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div aria-label="Page navigation example">
            <ul class="pagination">
                <c:forEach begin="1" end="${listColors.totalPages}" varStatus="loop">
                    <li class="page-item">
                        <a class="page-link" href="/danh-muc?page=${loop.begin+loop.count-2}">
...
<script>
    ...
    document.getElementById('trangThaiSelect').addEventListener('change', function() {
        ...
        if (selectedValue !== '') {
            window.location.href = '/danh-muc?trangThai=' + selectedValue;
        } else {
